...
class CLIPVisionTower(nn.Module):
    ...
    def load_model(self, device_map=None):
        ...
        CLIPVisionModelWithProjection._no_split_modules = ["CLIPVisionModelWithProjection"]
    ...
    def feature_select(self, image_forward_outs):
        ...
        image_attentions = image_forward_outs.attentions[self.select_layer] # [1, 16, 577, 577]
        image_embed = image_forward_outs.image_embeds # [1, 768]
        print(image_features.shape, image_attentions.shape, image_embed.shape)
    ...
    def forward(self, images):
        if type(images) is list:
            ...
            for image in images:
                ...
                print(image_forward_out.hidden_states[0].shape)
